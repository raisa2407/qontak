...
class DashboardController extends Controller
{
    ...
    {
        $organization_id = env('QONTAK_ORGANIZATION_ID');
        $base_url = 'https://chat-service.qontak.com/api/core/v1/' . $organization_id;
    ...
    private function calculateStats($rooms, $expiredRooms)
    {
        ...
        $assigned = $roomsCollection->where('status', 'assigned')->count();
